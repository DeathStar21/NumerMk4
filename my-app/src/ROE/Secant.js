...
// var x1=2
// var x2,e;
// function Secant(x,x1)
// {
//     return x1-(Math.log(x1-1)+cos(x1-1))*(x1-x)/ ((Math.log(x1-1)+cos(x1-1))-(Math.log(x-1)+cos(x-1)))
// }
// for(var i=2;i>0;i++)
// {
//     x2=Secant(x,x1)
//     console.log("x",i,"=",x2.toFixed(8))
//     e=Math.abs((x2-x1)/x2)
//     console.log("e =",e.toFixed(8))
//     if(e<0.000001)
//     {
//         break;
//     }
